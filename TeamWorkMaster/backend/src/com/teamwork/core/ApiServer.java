...
import com.teamwork.model.Comment; // MỚI THÊM
...
public class ApiServer {
    ...
    private CommentDAO commentDAO; // MỚI THÊM: Của đồng đội

    public ApiServer(int port) throws IOException {
        server = HttpServer.create(new InetSocketAddress(port), 0);
        userDAO = new UserDAO();
        taskDAO = new TaskDAO();
        commentDAO = new CommentDAO(); // MỚI THÊM
        ...
        // --- ENDPOINT BÌNH LUẬN CỦA ĐỒNG ĐỘI ---
    ...
    // ==========================================
    // API BÌNH LUẬN (ĐÃ ĐƯỢC CHUẨN HÓA BẢO MẬT)
    // ==========================================
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                if ("GET".equals(method)) {
                    // Lấy bình luận theo đúng TaskID truyền vào
                    ...
                    // Lấy ID người dùng thực tế đang đăng nhập để tránh giả mạo
